...
<Project Type="Project" LVVersion="12008004">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Exercises" Type="Folder">
			<Item Name="4 - Analysis and Output.vi" Type="VI" URL="../Exercises/4 - Analysis and Output.vi"/>
		</Item>
		<Item Name="Solutions" Type="Folder">
			<Item Name="2 - Simulate Signal to Graph (Solution).vi" Type="VI" URL="../Solutions/2 - Simulate Signal to Graph (Solution).vi"/>
			<Item Name="3 - Basic Measurement (Solution).vi" Type="VI" URL="../Solutions/3 - Basic Measurement (Solution).vi"/>
			<Item Name="4 - Analysis and Output (Solution).vi" Type="VI" URL="../Solutions/4 - Analysis and Output (Solution).vi"/>
			<Item Name="5 - Write to File (Solution).vi" Type="VI" URL="../Solutions/5 - Write to File (Solution).vi"/>
		</Item>
